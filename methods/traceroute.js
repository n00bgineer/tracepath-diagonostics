...
const IPTypes = {
  UNTRACEROUTABLE: '*',
  PRIVATE:
    /^(?:(?:10(?:\.\d{1,3}){3})|(?:100\.(?:6[4-9]|7[0-9])\.(?:\d{1,3}){2})|(?:192\.0\.0\.(?:\d{1,3}|25[0-5]|2[0-4]\d))|(?:192\.0\.2\.(?:\d{1,3}|25[0-5]|2[0-4]\d))|(?:192\.88\.99\.(?:\d{1,3}|25[0-5]|2[0-4]\d))|(?:192\.168(?:\.\d{1,3}){2})|(?:198\.(?:1[8-9]|2[0-9])\.(?:\d{1,3}|25[0-5]|2[0-4]\d))|(?:198\.51\.100\.(?:\d{1,3}|25[0-5]|2[0-4]\d))|(?:203\.0\.113\.(?:\d{1,3}|25[0-5]|2[0-4]\d))|(?:22[4-9]\.(?:\d{1,3}|25[0-5]|2[0-4]\d)\.(?:\d{1,3}|25[0-5]|2[0-4]\d))|(?:23[0-9]\.(?:\d{1,3}|25[0-5]|2[0-4]\d)\.(?:\d{1,3}|25[0-5]|2[0-4]\d))|(?:2[4-5][0-9]\.(?:\d{1,3}|25[0-5]|2[0-4]\d)\.(?:\d{1,3}|25[0-5]|2[0-4]\d))|(?:2[0-5]{2}\.(?:\d{1,3}|25[0-5]|2[0-4]\d)\.(?:\d{1,3}|25[0-5]|2[0-4]\d))|(?:172\.(?:1[6-9]|2\d|3[01])(?:\.\d{1,3}){2}))$/,
  GEOLOCATED: null,
  UNGEOLOCATED: null,
}
